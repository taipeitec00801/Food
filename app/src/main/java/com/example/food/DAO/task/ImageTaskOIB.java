...
public class ImageTaskOIB extends AsyncTask<Object, Integer, Bitmap> {
    ...
    public ImageTaskOIB(String url, int id, ImageView imageView) {
        this.url = url;
        this.id = id;
        this.imageViewWeakReference = new WeakReference<>(imageView);
    }

    public ImageTaskOIB(String url, int id, int position, ImageView imageView) {
        this.url = url;
        this.id = id;
